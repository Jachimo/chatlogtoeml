...
Segmentation behavior: short-segment preservation
-------------------------------------------------
...
conversations (for example, single-message segments), the converter now
coalesces runs of short segments and merges remaining short segments into an
adjacent neighbor (preferring the previous segment). If no neighbor exists the
